 ...
 * All changes must be documented in the [CHANGELOG.md](https://github.com/gbprod/doctrine-specification/blob/master/CHANGELOG.md) in respect of [Keep a Changelog](http://keepachangelog.com/) Standard.
